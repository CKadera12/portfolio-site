...
var Fade = function Fade() {
	...
	(0, _jquery2.default)(window).scroll(function () {
		...
		(0, _jquery2.default)('.hero').css('opacity', (0, _jquery2.default)('.hero').height / currentScrollTop);
		(0, _jquery2.default)('.hero__overlay').css('opacity', currentScrollTop / (0, _jquery2.default)('.hero__overlay').height() - .2);

		(0, _jquery2.default)('.contact__text-content').css('opacity', (currentScrollTop - ((0, _jquery2.default)(".portfolio").height() + 400)) * .002);
		(0, _jquery2.default)('.contact__overlay').css('opacity', 1 + ((0, _jquery2.default)(".portfolio").height() - currentScrollTop) * .0015);
		...
		(0, _jquery2.default)('.hero__image').css({
			'transform': 'translate(0, ' + currentScrollTop / 20 + '%)'
		});

		(0, _jquery2.default)('.hero__background--left').css({
			'transform': 'translate(0, ' + currentScrollTop / 20 + '%)'
		});
		(0, _jquery2.default)('.hero__background--right').css({
			'transform': 'translate(0, ' + currentScrollTop / 20 + '%)'
		});
...
var Modal = function () {
	function Modal() {
		...
		this.transitionLayer = (0, _jquery2.default)(".modal__transition-layer");
		this.backgroundLayer = (0, _jquery2.default)(".modal__bg-layer");
		this.currentScrollTop = (0, _jquery2.default)(window).scrollTop();
		this.events();
	}
...
var ParallaxMouse = function ParallaxMouse() {
  _classCallCheck(this, ParallaxMouse);

  var $layer_0 = (0, _jquery2.default)('.layer-0'),
      $layer_1 = (0, _jquery2.default)('.layer-1'),
      $layer_2 = (0, _jquery2.default)('.layer-2'),
      $layer_3 = (0, _jquery2.default)('.layer-3'),
      $x_axis = (0, _jquery2.default)('#x-axis'),
      $y_axis = (0, _jquery2.default)('#y-axis'),
      $container = (0, _jquery2.default)('body'),
      $header = (0, _jquery2.default)('.hero'),
      container_w = $container.width(),
      container_h = $container.height(),
      $currentScrollTop = (0, _jquery2.default)(window).scrollTop();

  (0, _jquery2.default)('.hero').on('mousemove.parallax', function (event) {
