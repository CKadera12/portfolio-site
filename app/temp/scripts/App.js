...
var Fade = function Fade() {
	...
	(0, _jquery2.default)(window).scroll(function () {
		...
		(0, _jquery2.default)('.contact__overlay').css('opacity', 1 + ((0, _jquery2.default)(".portfolio").height() - currentScrollTop) * .001);

		console.log(currentScrollTop);

		if (currentScrollTop > 960) {
			(0, _jquery2.default)('.hero').css('visibility', 'hidden');
		} else {
			(0, _jquery2.default)('.hero').css('visibility', 'visible');
		}
...
var Form = function Form() {
	...
	this.contactForm.on("submit", function () {
		...
		(0, _jquery2.default)(".contact__form").addClass("contact--disapear");
...
new _WorkLoad2.default((0, _jquery2.default)("#psycho"), "psycho.html");
...
new _ChangeProject2.default('#49ers');
new _ChangeProject2.default('#brandon-ingram');
new _ChangeProject2.default('#tony-hinchcliffe');
